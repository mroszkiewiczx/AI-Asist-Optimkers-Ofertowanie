...
// HubSpot Product IDs Mapping Database - Zaktualizowane wg specyfikacji
export const HS_PRODUCT_MAP = {
  modules: {
    crm: { 
      monthly: "261059750115", 
      yearly: "261066323176", 
      perpetual: "261071363293" 
    },
    aps: { 
      monthly: "261059030236", 
      yearly: "261067043057", 
      perpetual: "261067043058" 
    },
    mes_prod: { 
      monthly: "261067043062", 
      yearly: "261061189880", 
      perpetual: "261068483788" 
    },
    mes_real: { 
      monthly: "261068483785", 
      yearly: "261072083174", 
      perpetual: "261072083176" 
    },
    wms: { 
      monthly: "261072083177", 
      yearly: "261059750119", 
      perpetual: "261059750120" 
    },
    cmms: { 
      monthly: "261067043059", 
      yearly: "261058310356", 
      perpetual: "261061190846" 
    },
    admin: { 
      monthly: "261059030234", 
      yearly: "261058310355", 
      perpetual: "261064070361" 
    },
    integrator: { 
      monthly: "261068483783", 
      yearly: "261068483784", 
      perpetual: "261060469998" 
    },
  },
  implementation: {
    BASIC: "261061190849",
    PRO: "260831037668",
    PRO_MAX: "260831037669",
    extras: "261061910719"
  },
  care: {
    ELASTYCZNY: "261061189873",
    START_PLUS: "261061189881",
    ROZSZERZONY: "261064070362",
    PREMIUM: "261064070364",
    maintenance: "261059750121"
  }
};
...
export const IMPLEMENTATION_FEATURES: ImplementationFeature[] = [
  {
    ...
    features: [
      {
        id: "pre_analysis",
        label: "Analiza Przedwdrożeniowa",
        values: {
          BASIC: "Online (2h)",
          PRO: "U klienta (1 dzień)",
          PRO_MAX: "U klienta (3 dni)"
        }
      },
      {
        id: "documentation",
        label: "Dokumentacja Procesowa SOW",
        values: {
          BASIC: false,
          PRO: true,
          PRO_MAX: true
  ...
  },
  {
    ...
    features: [
      {
        id: "db_import",
        label: "Import Bazy Danych",
        values: {
          BASIC: "Szablony Excel",
          PRO: "Asysta przy imporcie",
          PRO_MAX: "Pełna migracja SQL"
        }
      },
      {
        ...
        values: {
          BASIC: "Standard (1 system)",
          PRO: "Zaawansowana (do 3)",
          PRO_MAX: "Nielimitowana"
        }
      }
    ]
  }
...
export const SLA_DEFINITIONS: Record<string, SLADefinition> = {
  ...
  START_PLUS: {
    ...
    reactionTime: "24h",
    manager: false,
    channels: ["E-mail", "Ticket System", "Telefon"]
  },
  ROZSZERZONY: {
    id: "ROZSZERZONY",
    label: "Rozszerzony",
    ...
    reactionTime: "8h",
    manager: true,
    channels: ["E-mail", "Ticket System", "Telefon", "Jira Share"]
  },
  PREMIUM: {
    id: "PREMIUM",
    label: "Premium",
    hours: "Nielimitowane",
    reactionTime: "2h (Krytyczne)",
    manager: true,
    channels: ["E-mail", "Ticket System", "Telefon", "Jira Share", "Slack/Teams"]
  }
};
